...
- I`ve started my notification by calling startForeground(SERVICE_NOTE_ID, note); But it doesn't work, it opens 'Chat' class not my resuming activity. here i created a question like http://stackoverflow.com/questions/26904705/android-displaying-multiple-activity-in-saved-state-when-notification-click
